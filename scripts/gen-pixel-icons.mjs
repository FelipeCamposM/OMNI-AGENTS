...
const ICONS = {
  ...
  /* Tipos de arquivo da árvore (ver `src/features/files/fileIcons.ts`).
     O app é monocromático por decisão de design, então a FORMA é o único diferenciador — por isso
     linguagens irmãs recebem glifos diferentes (braces/brackets/script/binary) em vez de todas
     caírem num `code` genérico, que devolveria 70 extensões com o mesmo desenho.
     O pacote não tem ícone de linguagem (só marcas: npm, docker, react, github...). */
  FileIcon: "file",
  ...
  MusicIcon: "music",
  WaveformIcon: "audio-waveform",
  HeadphoneIcon: "headphone",
  CodeIcon: "code",
  ScriptIcon: "script",
  BracesIcon: "braces",
  BracketsIcon: "brackets",
  BracketsAngleIcon: "brackets-angle",
  BinaryIcon: "binary",
  AlgorithmIcon: "algorithm",
  HashIcon: "hash",
  GearIcon: "gear",
  ...
  ClipboardNoteIcon: "clipboard-note",
  ...
  CpuIcon: "cpu",
  GpuIcon: "gpu",
  CircuitIcon: "circuit-board",
  TestTubeIcon: "test-tube",
  BugIcon: "bug",
  ToolsIcon: "tools",
  LabelIcon: "label",
  FlagIcon: "flag",
